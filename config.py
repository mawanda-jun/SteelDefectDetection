...
flags.DEFINE_string("run_name", "run5", "name of the current run")
...
flags.DEFINE_integer("img_w_res", 192*4, "resized width")
flags.DEFINE_integer("img_h_res", 192, "resized height")
